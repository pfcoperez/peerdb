...
require (
	...
	cloud.google.com/go/bigquery v1.77.0 // PINNED: v1.73.0+ requires google.golang.org/api v0.259.0
	...
	google.golang.org/api v0.287.1 // PINNED(DBI-443): v0.258.0 deprecates WithCredentialsJSON, migrate to WithAuthCredentialsJSON
